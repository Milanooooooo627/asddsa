...
if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    Write-Host "1. Right-clicking on Run-Proton-HWID-Spoofer.bat" -ForegroundColor Yellow
...
function Show-Menu {
    Clear-Host
    Write-Host "================ Proton HWID SPOOFER ================" -ForegroundColor Cyan
    ...
    Write-Host "9. Proton Cleaner" -ForegroundColor Yellow
    Write-Host "10. Exit" -ForegroundColor Red
    Write-Host "=============================================" -ForegroundColor Cyan
}


function Invoke-ProtonCleaner {
    Clear-Host
    Write-Host "===============================================" -ForegroundColor Cyan
    Write-Host "             Proton System Cleaner" -ForegroundColor Cyan
    Write-Host "===============================================" -ForegroundColor Cyan
    Write-Host ""
    ...
    Write-Host ""
    Write-Host "Press any key to return to the Proton Cleaner menu..." -ForegroundColor Cyan
    $null = $Host.UI.RawUI.ReadKey('NoEcho,IncludeKeyDown')
    Invoke-ProtonCleaner
}
