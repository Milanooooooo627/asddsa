# Proton Peripheral Serial Number Hider
...
function Show-Menu {
    Clear-Host
    Write-Host "=================================================================" -ForegroundColor Cyan
    Write-Host "           Proton Peripheral Serial Number Hider               " -ForegroundColor Cyan
    Write-Host "=================================================================" -ForegroundColor Cyan
...
do {
    ...
    switch ($choice) {
        ...
        "0" {
            Write-Host "`nExiting Proton Peripheral Serial Number Hider..." -ForegroundColor Cyan
            break
        }
