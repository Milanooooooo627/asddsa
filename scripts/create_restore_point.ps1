...
Write-Host "          Proton - System Restore Point" -ForegroundColor Cyan
Write-Host "===============================================" -ForegroundColor Cyan
Write-Host "" 
...
Write-Host "2. Return to Proton when finished." -ForegroundColor Green
Write-Host "" 
